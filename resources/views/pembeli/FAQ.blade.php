...
<div class="py-12 px-2">
    ...
    <div class="mb-6 flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-gray-400 mt-3">Temukan jawaban atas pertanyaan umum seputar belanja di Kriya Rajut.</p>
        </div>
    ...
    <div class="flex gap-12">
        ...
        <div class="flex-1 min-w-0 space-y-12">
            ...
            <div class="faq-section" data-kategori="pembayaran">
                ...
                <div class="divide-y divide-gray-100">
                    @foreach([
                        ['q' => 'Metode pembayaran apa saja yang tersedia?', 'a' => 'Saat ini kami menerima pembayaran melalui transfer bank (BNI). Metode lain akan segera menyusul.'],
            ...
            <div class="faq-section" data-kategori="pengiriman">
                ...
                <div class="divide-y divide-gray-100">
                    @foreach([
                        ['q' => 'Ke mana saja pengiriman bisa dilakukan?', 'a' => 'Kami melayani pengiriman ke seluruh wilayah Indonesia melalui jasa ekspedisi terpercaya.'],
                        ...
                        ['q' => 'Bagaimana cara melacak status pesanan saya?', 'a' => 'Kunjungi halaman Lacak Pesanan, masukkan email dan nomor telepon yang kamu gunakan saat memesan.'],
                    ] as $item)
                    <div class="faq-item">
                        <button onclick="toggleFaq(this)"
                            class="w-full flex justify-between items-center py-4 text-left text-sm text-[#001f3f] hover:text-gray-500 transition-colors duration-150">
            ...
            {{-- CTA Box --}}
            <div class="bg-white border border-gray-200 rounded-xl px-8 py-10 text-center">
                <p class="text-sm text-gray-400 mb-6">Tidak menemukan jawaban yang kamu cari? Hubungi kami langsung.</p>
...
function filterKategori(kat) {
    ...
    document.querySelectorAll('.faq-btn').forEach(btn => {
        btn.className = 'faq-btn w-full text-left px-3 py-2.5 text-[11px] uppercase tracking-widest transition-all duration-150 text-gray-400 hover:text-[#001f3f] border-l-2 border-transparent';
    });
    const active = document.getElementById('btn-' + kat);
    if (active) active.className = 'faq-btn w-full text-left px-3 py-2.5 text-[11px] uppercase tracking-widest transition-all duration-150 text-[#001f3f] font-bold border-l-2 border-[#001f3f] bg-white';
}
</script>
@endsection