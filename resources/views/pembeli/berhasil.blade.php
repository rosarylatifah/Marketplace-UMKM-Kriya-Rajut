...
<div class="py-12 flex justify-center items-center">
    <div class="w-full max-w-lg bg-white border border-gray-200 rounded-xl p-12 text-center">
        ...
        {{-- Info Box --}}
        <div class="bg-[#F3F5F1] rounded-lg px-6 py-5 text-left mt-8 space-y-3">
            <div class="flex justify-between items-center">
                <span class="text-[10px] uppercase tracking-[0.2em] text-gray-400">Status Pesanan</span>
                <div class="flex items-center gap-2">
                    <span class="inline-block w-1.5 h-1.5 rounded-full bg-emerald-400"></span>
                    <span class="text-[11px] font-bold uppercase tracking-widest text-emerald-600">Dikonfirmasi</span>
                </div>
            </div>
    ...
    <div style="font-family: 'Plus Jakarta Sans', sans-serif; max-width: 600px; margin: 0 auto; padding: 48px; color: #001f3f;">
        ...
        <table style="width: 100%; font-size: 13px; border-collapse: collapse; margin-bottom: 24px;">
            ...
            <tr style="border-bottom: 1px solid #f3f5f1;">
                ...
                <td style="padding: 12px 0; font-weight: 700; text-align: right;">Transfer Bank BNI</td>
            </tr>
            <tr>
