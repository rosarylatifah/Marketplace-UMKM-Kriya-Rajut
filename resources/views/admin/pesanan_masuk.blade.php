                                ...
                                <div class="relative bg-white border border-gray-300 p-6 shadow-2xl text-left rounded-xl">
                                    ...
                                    <div class="flex flex-col gap-4">
                                        ...
                                        <div class="space-y-3 text-xs">
                                            ...
                                            {{-- Grid Rincian Harga Produk, Ongkir, dan Total Akhir --}}
                                        ...
                                        <div class="mt-4 pt-4 border-t border-gray-100">
                                            @php
                                                ...
                                                $pesanWA = "Halo " . $p->nama_pembeli . ", kami dari Admin Kriya Rajut (Namonic) ingin mengonfirmasi bahwa pesanan Anda dengan ID " . $p->id_pesanan . " senilai Rp " . number_format($p->total, 0, ',', '.') . " telah kami terima dan saat ini sedang dalam proses. Mohon ditunggu ya! Terima kasih banyak. ❤️";
                                                $linkWA = "https://api.whatsapp.com/send?phone=" . preg_replace('/[^0-9]/', '', $nomorTujuan) . "&text=" . urlencode($pesanWA);
                                            @endphp
                                            <a href="{{ $linkWA }}" target="_blank" class="flex items-center justify-center gap-2 w-full text-center bg-blue-600 hover:bg-blue-700 text-white font-bold text-[11px] uppercase tracking-wider py-3 rounded-lg transition-all shadow-md">
