...
<body class="bg-gray-50 flex items-center justify-center min-h-screen">
    <div class="w-full max-w-md bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
        ...
        <p class="text-gray-500 text-sm text-center mb-6">Masukkan email admin lu. Setelah diklik, silakan intip link reset password-nya di file <span class="font-mono bg-gray-100 text-red-600 px-1 rounded">storage/logs/laravel.log</span> ya!</p>
        ...
        <form action="{{ route('admin.password.email') }}" method="POST">
            ...
            <div class="mb-5">
                ...
                <input type="email" name="email" value="{{ old('email') }}" required 
                       ...
                       placeholder="adminrajut@gmail.com">
                @error('email')
